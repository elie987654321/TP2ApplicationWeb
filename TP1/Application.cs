namespace TP1
{
    public class Application
    {
        static void Main(string[] args)
        {
            ...
            Jeu jeu2 = new Jeu("Borderlands 3", Jeu.TypeDeJeu.FPS,
            ...
            Jeu jeu3 = new Jeu("Stardew Valley", Jeu.TypeDeJeu.Simulation_De_Ferme, new Evaluation(Evaluation.Cote.EXCELLENT, "Vous " +
            ...
            Jeu jeu4 = new Jeu("Valheim", Jeu.TypeDeJeu.Survie, new Evaluation(Evaluation.Cote.EXCELLENT, "Un jeu multijoueur brutal " +
            ...
            Jeu jeu5 = new Jeu("Atomic Heart", Jeu.TypeDeJeu.Horreur, new Evaluation(Evaluation.Cote.TRES_BON, "Dans un monde " +
            ...
            Jeu jeu6 = new Jeu("Returnal", Jeu.TypeDeJeu.Roguelike, new Evaluation(Evaluation.Cote.TRES_BON, "BRISEZ LE CYCLE Combattez pour votre survie dans ce jeu de tir à " +
            ...
            Jeu jeu7 = new Jeu("Sid Meier’s Civilization VI", Jeu.TypeDeJeu.Strategie, new Evaluation(Evaluation.Cote.TRES_BON, 
            ...
            Jeu jeu8 = new Jeu("NBA 2K23", Jeu.TypeDeJeu.Sport, new Evaluation(Evaluation.Cote.MOYEN, "Soyez à la " +
            ...
            Jeu jeu9 = new Jeu("Grand Theft Auto V", Jeu.TypeDeJeu.Crime, new Evaluation(Evaluation.Cote.TRES_BON, "Grand Theft Auto V offre aux joueurs la " +
            ...
            Jeu jeu10 = new Jeu("Resident Evil Village", Jeu.TypeDeJeu.Horreur, new Evaluation(Evaluation.Cote.EXCELLENT, "Survie et épouvante atteignent des sommets " +
