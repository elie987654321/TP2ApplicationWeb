namespace TP1
{
    public class Application
    {
        static void Main(string[] args)
        {
            ...
            Jeu jeu3 = new Jeu("Stardew Valley", Jeu.TypeJeu.Simulation_De_Ferme, new Evaluation(Evaluation.Cote.EXCELLENT, "Vous " +
            ...
            Jeu jeu4 = new Jeu("Valheim", Jeu.TypeJeu.Survie, new Evaluation(Evaluation.Cote.EXCELLENT, "Un jeu multijoueur brutal " +
            ...
            Jeu jeu5 = new Jeu("Atomic Heart", Jeu.TypeJeu.Horreur, new Evaluation(Evaluation.Cote.TRES_BON, "Dans un monde " +
            ...
            Jeu jeu6 = new Jeu("Returnal", Jeu.TypeJeu.Roguelike, new Evaluation(Evaluation.Cote.TRES_BON, "BRISEZ LE CYCLE Combattez pour votre survie dans ce jeu de tir à " +
            ...
            Jeu jeu7 = new Jeu("Sid Meier’s Civilization VI", Jeu.TypeJeu.Strategie, new Evaluation(Evaluation.Cote.TRES_BON, 
            ...
            Jeu jeu8 = new Jeu("NBA 2K23", Jeu.TypeJeu.Sport, new Evaluation(Evaluation.Cote.MOYEN, "Soyez à la " +
            ...
            Jeu jeu9 = new Jeu("Grand Theft Auto V", Jeu.TypeJeu.Crime, new Evaluation(Evaluation.Cote.TRES_BON, "Grand Theft Auto V offre aux joueurs la " +
            ...
            Jeu jeu10 = new Jeu("Resident Evil Village", Jeu.TypeJeu.Horreur, new Evaluation(Evaluation.Cote.EXCELLENT, "Survie et épouvante atteignent des sommets " +
            ...
            utilisateur1.AjouterFavori(jeu10);
